...
The Human Textile Reference is a set of short, easy to understand HTML pages you can include in any project that uses Textile. "View a demo.":http://labs.metanation.com/human-textile-reference/
